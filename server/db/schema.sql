-- Spectra MySQL schema - Migración completa
-- Ejecutar vía: mysql -u USER -p DATABASE < schema.sql
-- O vía SSH: ver scripts/migrate-mysql-ssh.sh o migrate-mysql-ssh.ps1

-- Crear base si no existe
CREATE DATABASE IF NOT EXISTS spectra CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE spectra;
...
-- ============ MIGRACIONES (opcionales si ya existen las columnas) ============
-- Ejecutar con mysql -f para continuar ante errores "Duplicate column name"
...
-- ============ ÍNDICES (ignorar si ya existen con mysql -f) ============
