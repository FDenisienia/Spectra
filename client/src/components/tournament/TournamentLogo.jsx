const SPORT_LOGOS = {
  ...
  futbol_femenino: {
    bannerSrc: null,
    crestSrc: '/images/estrellas-futbol-logo.png?v=3',
    bgClass: 'tournament-logo--futbol-hero',
    alt: 'Estrellas del Fútbol Femenino',
    whiteFilter: false,
  },
  futbol_mixto: {
    bannerSrc: null,
    crestSrc: '/images/estrellas-futbol-mixto-logo.png?v=3',
    bgClass: 'tournament-logo--futbol-hero',
  ...
  futbol_masculino: {
    bannerSrc: null,
    crestSrc: '/images/estrellas-futbol-masculino-logo.png?v=3',
    bgClass: 'tournament-logo--futbol-hero',
