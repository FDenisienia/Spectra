const SPORT_LOGOS = {
  padel: { src: '/images/smash-open-logo.png', alt: 'Smash Open', whiteFilter: true },
...
export default function TournamentLogo({ sport, gender }) {
  let logoKey = sport
  ...
  if (!logo) return null
  return (
    <div className={`tournament-logo ${logo.whiteFilter ? 'tournament-logo--white' : ''}`}>
